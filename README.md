...
<img src="img/spring-boot.xcf" alt="some text" width=150 height=100>
...
Praticamente o projeto foi desenvolvido por IntelliJ e terminal do ubuntu, o que pode ser considerado tiring e challenge para alguns, no fim das contas consegui absorver alguns comandos que salvam tempo. Começa agora as configurações do banco de dados na aplicação, expor os bancos de dados com recurso REST. Clonou-se o banco de dados das cidade do autor chinnon <a href="https://github.com/chinnonsantos/sql-paises-estados-cidades"></a> , que foi utilizado como db.
